               ...
               <div class="container-fluid section-menu ">
                  <div class="row">
                     ...
                     <div class="col-md-8 home-about wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        ...
                        <p >Cey -Nor Foundation Limited is the one and only pioneering Government Company 
                           that manufactures boats and marine equipment with government trust. 
                           The company is corporate with a Norwegian Non -Governmental Organization since 
                           1967 to manufacture boats with the latest technology and sustainable values.
                        </p>
                     </div>
                     ...
                     <div class="col-sm-6 half-right">
                        <div class="writing-sec">
                           ...
                           <p class="wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.3s">
                            <ul>
                                <li><h5>Only boat manufacturing company owned by the Sri Lankan Government.</h5></li>
                                <li><h5>Head office located in the heart of Colombo.</h5></li>
                                <li><h5>Market Leader in manufacturing whale watching boat.</h5></li>
                                <li><h5>Boatyard facilities in Mattakuliya (Colombo 15) & Karainagar (Jaffna District - Nothern Peninsula) with having convenient launching pad with zero charge.</h5></li>
               ...
               <div class="container-fluid">
                  <div class="row m-0">
                     ...
                     <div class="col-sm-7 half-right">
                        <div class="writing-sec">
                           <div class="thm-h">
                              <h2 class="wow fadeInUp" data-wow-duration="0.7s">MATTAKKULIYA BOAT YARD</h2>
                              <h4></h4>
                           </div>
                           <p class="wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.3s">This is the main boat yard of Cey - Nor Foundation. The boatyard has been
                              brought up to the internationally recognized level with the provision of the most modern
                              equipment and technological breakthroughs such as ISO 9001:2015 and fiberglass
                              production facility with humidity control system (AC chamber area). 
                           </p>
                  ...
                  <div class="row m-0 rtl-sec">
                     <div class="col-sm-5 half-right">
                        <div class="img-sec wow fadeInRight" data-wow-duration="1s" >
                           <img class="img-fluid" src="assets/images/Karainagar.jpg">
                        </div>
                     </div>
                     <div class="col-sm-7 half-left ">
                        <div class="writing-sec wow fadeInLeft" data-wow-duration="1s" >
                           <div class="thm-h">
                              <h2>KARAINAGAR BOAT YARD</h2>
                              
                           </div>
                           <p>Under the rehabilitation program in the North &amp; Karainagar in 2009, the
                              government invested for rehabilitating Cey – Nor Karainagar boat yard. In 2017, the
                              government transferred ownership to the Cey-Nor foundation for operations of boat
                              manufacturing, and currently, Cey- Nor has already started its production in the renewed
                              boatyard. Karainagar boat yard has a 1 acre &amp; 3-rood area yard &amp; two large guest rooms
                     ...
                     <div class="col-md-3">
                        <div class="servicebox-first">
                           <div class="thm-h text-center">
                              ...
                              <br>
                              <p>Cey - Nor Foundation manufactures not only high-quality fishing vessels and
                                 leisure crafts but also provides various products and services in order to full fill your marine
                                 experience.</p>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="row servicebox-row">
                           ...
                           <div class="col-md-4">
                            <div class="servicebox">
                               ...
                               <h4>Fishing Nets & Other Products</h4>
                               <p></p>
                               {{-- <a class="servicemore" href="#">More</a> --}}
                            </div>
                         </div>
                           ...
                           <div class="col-md-4">
                              <div class="servicebox">
                                 <img src="assets/images/service9.png">
                                 <h4> Life Jackets & Boat Engines</h4>
                                 <p></p>
                                 {{-- <a class="servicemore" href="#">More</a> --}}
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="servicebox">
                                 <img src="assets/images/service11.png">
                                 <h4>Any Fiber Repairs and Boat Repairs</h4>
                                 <p></p>
                                 {{-- <a class="servicemore" href="#">More</a> --}}
                              </div>
                           </div>
                  ...
                  <div class="row m-0 ">
                     ...
                     <div class="col-sm-12 instagram-wrap text-center">
                        <div class="MagicScroll" data-options="arrows: inside; mode: cover-flow;  draggable: false ;scrollOnWheel: true; ">
                           ...
                           @php
                           $image= App\Models\Gallery::all();
                           @endphp
                          
                           @foreach ($image as $item)
                           <img  style="width: 500x; height:258px;" src="uploads/gallery/{{ $item->image }}" alt="">
                           @endforeach

                           {{-- <img src="assets/images/duck-boat-pond-bangkok (1).jpg" alt=""> --}}
                           
                           {{-- <img src="assets/images/duck-boat-pond-bangkok (1).jpg" alt="">
                           <img src="assets/images/FMU_8369.jpg" alt="">
                           <img src="assets/images/IMG_1276.jpg" alt="">
                           <img src="assets/images/IMG_1535.jpg" alt="">
                           <img src="assets/images/IMG_1720.jpg" alt="">
                           <img src="assets/images/IMG_1918.jpg" alt="">
                           <img src="assets/images/IMG_2083.jpg" alt="">
                           <img src="assets/images/kayaking-man-paddling-kayak-canoeing-paddling (1).jpg" alt="">
                           <img src="assets/images/Original (1).jpg" alt="">
                           <img src="assets/images/P9090087.jpg" alt="">
                           <img src="assets/images/Picture 024.jpg" alt=""> --}}

                           
                        </div>
                     </div>
                     <div class="col-auto btn-wrap-center">
                        <a href="{{ route('all.gallery') }}" class="read-more button-fancy -color-1 wow fadeInUp" data-wow-duration="1s"><span class="btn-arrow"></span><span class="twp-read-more text">View All</span></a> 
                     </div>
                  </div>
               </div>
            </section>
