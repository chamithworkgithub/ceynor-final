  ...
  <div class="header-inner hi-about-us mb-0">
      <div class="header-cont container-fluid">
        <div class="y-breadcrum clearfix wow fadeInDown " data-wow-delay=".9s">
              <h1 class="y-heading">Other Products</h1> 
            ...
            <div class="container-fluid">
                <div class=" y-single_info_inner y-section_content">
                  <div class="y-product_listing y-product_listing_side row m-0 ">
                    ...
                    @foreach ($otherpro as $item)
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                      <div class="y-yacht_intro_img">
                        <a href=""><img src="../uploads/otherproducts/{{ $item->image }}" style="width: 800px; 594px;"  class="img-fluid" alt=""></a>
                      </div>
                      <div class="y-yacht_intro">
                        <a href="">{{ $item->product_name }}</a>
                        <ul>
                          <li><img src="{{ url('assets/images/icon_04.png') }}" alt="">Length : {{ $item->length }}</li>
                          <li><img src="{{ url('assets/images/bed.png') }}" alt=""> Height : {{ $item->height }}</li>
                        </ul> 
                        
                        <a href="{{ route('viewmore_op',$item->id) }}" class="read-more button-fancy -color-1"><span class="btn-arrow"></span><span class="twp-read-more text">More Details</span></a>
                      </div> 
                    </div> 
                    @endforeach
