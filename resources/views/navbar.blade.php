    ...
    <div class=" fixed-top  container-fluid">
       <div class="row menu-1-inner justify-content-between"  >
          <div class="col-auto menu-1-logo">
             ...
             <img class="nb-light" src="{{ asset('assets/images/govementlogo.png') }}">
             <img class="nb-dark" src="{{ asset('assets/images/govementlogo.png') }}">
          ...
          <div class="col-md-7 main_nav_outer">
             <nav class="main_nav">
                ...
                <div class="dropdown ">
                  <a class="btn btn-primary {{ 'ourprojects' == request()->path() ? 'active' : '' }}" href="{{ route('ourprojects') }}" >
                     Our Projects
                 </a>
                </div>
                ...
                <div class="sidenav_cat">
                   ...
                   <ul class="">
                     ...
                     <li class="nav-item dropdown">
                      ...
                      <li class="nav-item ">
                        <a class="dropdown-item {{ 'ourprojects' == request()->path() ? 'active' : '' }}" href="{{ route('ourprojects') }}"> Our Projects</a>                                             
                      </li>
                      <li class="nav-item">                 
